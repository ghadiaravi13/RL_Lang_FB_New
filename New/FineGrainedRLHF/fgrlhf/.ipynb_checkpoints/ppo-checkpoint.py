...
class PPOTrainer:
    ...
    def train(self, step):
        ...
        lm_head_wt_0 = self.accelerator.unwrap_model(self.policy_model.model).lm_head.weight[lm_head_default_dim*0:lm_head_default_dim*1,:]
        lm_head_wt_1 = self.accelerator.unwrap_model(self.policy_model.model).lm_head.weight[lm_head_default_dim*1:lm_head_default_dim*2,:]
        lm_head_wt_2 = self.accelerator.unwrap_model(self.policy_model.model).lm_head.weight[lm_head_default_dim*2:lm_head_default_dim*3,:]

        init_lm_head_wt_0 = self.policy_model.init_lm_head[lm_head_default_dim*0:lm_head_default_dim*1,:]
        init_lm_head_wt_1 = self.policy_model.init_lm_head[lm_head_default_dim*1:lm_head_default_dim*2,:]
        init_lm_head_wt_2 = self.policy_model.init_lm_head[lm_head_default_dim*2:lm_head_default_dim*3,:]
        ...
        if self.args['logging']['wandb_log'] and self.accelerator.is_main_process:
            ...
            if step % self.args['logging']['log_interval'] == 0:
                wandb.log({
                    ...
                    'train/lm_head_wts/var_0': lm_head_wt_0.var(),
                    'train/lm_head_wts/var_1': lm_head_wt_1.var(),
                    'train/lm_head_wts/var_2': lm_head_wt_2.var(),
